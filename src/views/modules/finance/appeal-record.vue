<template>
  <div>
    <AppealRecordList v-show="key == 0" :fun="look" :data="signTime"/>
    <AppealRecordDetail v-if="key == 1" :data="row" :fun="back"  @getDetailId="getDetailId"/>
...
<script>
import AppealRecordList from './appeal-record-list'
import AppealRecordDetail from './appeal-record-detail'
