<template>
    <div id="home" class="home" :class="{homeFixed:fullScreen}">
        <div class="title">
            ...
            <div class="datetime">
                <span class="tmfamily" style="width:150px;">{{date}}</span>
                <span class="tmfamily" style="width:120px;">{{time}}</span>
                    ...
                    <div class="items itemsLTop">
                        <div class="item itemL">
                            ...
                            <div class="txt tx1 number">
                                <span class="txt1">{{prices?prices.price92:''}}</span>
                        ...
                        <div class="item itemR">
                            ...
                            <div class="txt tx1 number">
                                <span class="txt1">{{prices?prices.price95:''}}</span>
                                <span class="txt2">元</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="items itemsLTop">
                        <div class="item itemL">
                            ...
                            <div class="txt number">
                                <span class="txt1">{{salesItems?salesItems.oils92SalesQuantity:''}}</span>
                        ...
                        <div class="item itemR">
                            <div class="tir number">95#</div>
                            <div class="txt number">
                                <span class="txt1">{{salesItems?salesItems.oils95SalesQuantity:''}}</span>
                                <span class="txt2">升</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="items itemList">
                        <div class="itemListTable">
                            <table>
                                ...
                                <tbody>
                                    <tr v-for="(i,key) in stationInCars" :key="key">
                                        <td>{{key+1}}</td>
                                        <td>{{i.inTime}}</td>
                                        <td>{{i.carNo}}</td>
            ...
            <div class="content">
                <div class="machineBox">
                    <el-row :gutter="10" class="machineRow">
                        ...
                        <el-col :span="8" class="machineItem" v-for="(i,key) in ITACHA" :key="key">
                            <div class="machineM">
                                <div class="titTop">
                                ...
                                <div class="machineIn" v-if="i.machineEntities">
                                    <div class="machineItem machineItemL" v-if="i.machineEntities[0]">
                                        <div class="itemBg">
                                            <div class="oil">
                                                <div class="txtRow number" v-if="i.machineEntities[0]">
                                             ...
                                             <!-- <img src="~@/assets/img/home/weiguaqiang.png" alt="" class="left" v-if="i.machineEntities[0]&&i.machineEntities[0].guns[0].gunStatus == '0'"> -->
                                            <img src="~@/assets/img/home/zhengzaijiayou.png" alt="" class="left jiayou" v-if="i.machineEntities&&i.machineEntities[0]&&i.machineEntities[0].guns[0].gunStatus == '2'">
                                            <!-- <img src="~@/assets/img/home/weiguaqiang.png" alt="" class="right" v-if="i.machineEntities[0]&&i.machineEntities[0].guns[1].gunStatus == '0'"> -->
                                            <img src="~@/assets/img/home/zhengzaijiayou.png" alt="" class="right jiayou" v-if="i.machineEntities&&i.machineEntities[0]&&i.machineEntities[0].guns[1].gunStatus == '2'">
                                        </div>
                                        <div class="carIn">
                                            <span class="carInTx1" v-if="i.machineEntities&&i.machineEntities[0]&&i.machineEntities[0].guns[0].gunStatus == '2'">{{i.machineEntities[0].guns[0].carNo}}</span>
                                            <span class="carInTx2" v-if="i.machineEntities&&i.machineEntities[0]&&i.machineEntities[0].guns[1].gunStatus == '2'">{{i.machineEntities[0].guns[1].carNo}}</span>
                                        </div>
                                    </div>
                                    <div class="machineItem machineItemR" v-if="i.machineEntities[1]">
                                        <div class="itemBg">
                                            <div class="oil">
                                                <div class="txtRow number" v-if="i.machineEntities[1]">
                                                     <div>{{i.machineEntities[1].guns[0].gunName}}</div>
                                                    <div>{{i.machineEntities[1].guns[1].gunName}}</div>
                                                </div>
                                                <div class="txtRow number" v-if="i.machineEntities[1]">
                                                    <div>{{i.machineEntities[1].guns[0].gasolineNum}}#</div>
                                                    <div>{{i.machineEntities[1].guns[1].gasolineNum}}#</div>
                                                </div>
                                            </div>
                                            <!-- <img src="~@/assets/img/home/weiguaqiang.png" alt="" class="left" v-if="i.machineEntities[1]&&i.machineEntities[1].guns[0].gunStatus == '0'"> -->
                                            <img src="~@/assets/img/home/zhengzaijiayou.png" alt="" class="left jiayou" v-if="i.machineEntities[1]&&i.machineEntities[1].guns[0].gunStatus == '2'">
                                            <!-- <img src="~@/assets/img/home/weiguaqiang.png" alt="" class="right" v-if="i.machineEntities[1]&&i.machineEntities[1].guns[1].gunStatus == '0'"> -->
                                            <img src="~@/assets/img/home/zhengzaijiayou.png" alt="" class="right jiayou" v-if="i.machineEntities[1]&&i.machineEntities[1].guns[1].gunStatus == '2'">
                                        </div>
                                        <div class="carIn">
                                            <span class="carInTx1" v-if="i.machineEntities[1]&&i.machineEntities[1].guns[0].gunStatus == '2'">{{i.machineEntities[1].guns[0].carNo}}</span>
                                        <span class="carInTx2" v-if="i.machineEntities[1]&&i.machineEntities[1].guns[0].gunStatus == '2'">{{i.machineEntities[1].guns[1].carNo}}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default {
  ...
  methods: {
    ...
    search(){
      this.$http
      .get(this.$http.adornUrl(`/business/work/manageInfo`))
      .then(res => {
        ...
        this.ITACHA = res.data.machineAllInfo;
        // console.log('search:');
        // console.log(res.data)
        // console.log(this.ITACHA);
        // console.log(this.ITACHA[0].machineStatus!=='0')
